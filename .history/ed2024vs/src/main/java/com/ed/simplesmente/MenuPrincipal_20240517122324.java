...
public class MenuPrincipal {
	...
	public static void main(String[] args) throws IOException {
		...
		do {
			...
			try {
				opcao = scan.nextInt(); // Alterado para ler um inteiro
			} catch (InputMismatchExceptiongit zz e) {
				System.out.println("Opção inválida. Por favor, insira um número inteiro.");
				scan.next(); // Limpa o buffer do scanner
				opcao = -1; // Define opção como -1 para continuar no loop
			}

			switch (opcao) {
				case 1: // Alterado para número inteiro
					...
					break;
				case 2: // Alterado para número inteiro
					...
					pausa();
					break;
				case 3: // Alterado para número inteiro
				...
				case 6: // Alterado para número inteiro
					...
					pausa();
					break;
				case 7: // Alterado para número inteiro
					...
					pausa();
					break;
				case 8: // Alterado para número inteiro
					...
					pausa();
					break;
				case 9: // Alterado para número inteiro
					System.out.println("Digite o valor a ser procurado:");
					...
					pausa();
					break;
				case 10: // Alterado para número inteiro
